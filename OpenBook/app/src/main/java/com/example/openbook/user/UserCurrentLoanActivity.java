...
public class UserCurrentLoanActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_current_loan);
    ...
    private void askReviewAfterReturn(String isbn) {
        new android.app.AlertDialog.Builder(this)
                ...
                .setPositiveButton("작성할래요", (dialog, which) -> {
                    Intent intent = new Intent(UserCurrentLoanActivity.this, UserReviewWriteActivity.class);
